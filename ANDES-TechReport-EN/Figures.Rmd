...
(ref:screenshot-charts-caption) A screenshot of the Charts module showing the weight _vs_ length scatter plot on top of its growth curve model.
...
(ref:screenshot-oceanography-sample-caption) A screenshot of the Oceanographic Sample detail page from the Andes Oceanography module.
...
(ref:screenshot-oceanography-activity-caption) A screenshot of the Oceanographic Activity detail page from the Andes Oceanography module. Note that 'Yellow Belly' refers to the colloquial name of the CTD/Rosette system.
...
```{r screenshot-port-protocol, fig.cap="(ref:screenshot-port-protocol)", out.width='1.0\\linewidth'}
...
(ref:screenshot-fishing-console-caption) A screenshot of Andes Fishing Console withing the Bridge module. This screenshot shows some quality control validation features including: the fishing timer, the distance display and an alarm message for when the vessel is travelling outside the target stratum. On the bottom left of the screenshot, output from the net monitoring system is displayed. The large buttons in the center of the display are used to trigger fishing events.
