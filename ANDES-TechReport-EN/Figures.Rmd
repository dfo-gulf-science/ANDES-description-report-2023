...
(ref:ERD_ES-caption) A simplified entity relationship diagram of the data model used by the Ecosystem Survey app of \gls{andes}.

```{r ERD_ES, fig.cap="(ref:ERD_ES-caption)", out.width='1.0\\linewidth'}
