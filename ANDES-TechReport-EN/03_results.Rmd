...
\item[ELOG report]{This report emulates the .log summary report produced by \gls{elog}.
This report is required in order to upload the survey data into the Microsoft Access template currently used by AZMP to load data to BioChem, DFOs national repository for discrete and plankton data.}
\end{description}
