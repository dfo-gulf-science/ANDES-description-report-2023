...
The Charts module (Figure \@ref(fig:screenshot-charts)) leverages the Bokeh Python library to visualize both length-weight relationships and length frequencies in an interactive way. It allows the creation of charts for various combinations of sets, species, and variables in order to easily identify outliers that may go unnoticed during data entry despite the implemented quality controls. Users can also access specimen data in a data-entry edit mode to conveniently modify information for any specimen.
