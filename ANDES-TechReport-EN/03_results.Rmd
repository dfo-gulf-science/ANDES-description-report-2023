...
The \gls{Ecosystem Survey} app is the main entry point that technicians will use to input survey data. A depiction of the main tables involved in the Ecosystem data entry application, and their relationships are displayed in Figure \@ref(fig:erd-ecosystem-survey). This component of \gls{andes} replicates the capabilities of the \gls{ese} for capturing detailed information on length, weight, ageing material, maturity, etc. about fish and invertebrate specimens. This app, typically accessed from the wet laboratory of a survey vessel, is used for all entry of data related to measurements and observations of marine organisms. 
