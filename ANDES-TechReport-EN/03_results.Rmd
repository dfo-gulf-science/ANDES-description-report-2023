...
The simplified \gls{ERD} of the Oceanographic module of \gls{andes} is presented in Figure \@ref(fig:erd-oceanography). The Oceanography app is a stand-alone component of the application that is capable of being deployed independently of the Ecosystem Survey module. This module is used to track and record the deployment of CTDs, plankton nets, Argo floats and other oceanographic equipment (Figure \@ref(fig:screenshot-oceanography-sample). Basic metadata, such as the location and timestamp of deployment and recovery can be collected for each activity. Certain oceanographic activities allow deeper layers of metadata collection such as the tracking of water samples from CTDs ((Figure \@ref(fig:screenshot-oceanography-activity)).
