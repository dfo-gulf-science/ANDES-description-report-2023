...
%%% define the acronym and use the see= option
\newglossaryentry{imts}{type=\acronymtype, name={IMTS}, description={Fisheries and Oceans Canada, formerly the Department of Fisheries and Oceans}, first={Information Management and Technology Services (IMTS)\glsadd{imtsg}}, see=[Glossary:]{imtsg}}
...
%%% define the acronym and use the see= option
\newglossaryentry{lan}{type=\acronymtype, name={LAN}, description={Fisheries and Oceans Canada, formerly the Department of Fisheries and Oceans}, first={local area network (LAN)\glsadd{lang}}, see=[Glossary:]{lang}}
