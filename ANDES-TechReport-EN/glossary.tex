...
%%% define the acronym and use the see= option
\newglossaryentry{azomp}{type=\acronymtype, name={AZOMP}, description={Atlantic Zone Offshelf Monitoring Program}, first={Atlantic Zone Offshelf Monitoring Program (AZMP)\glsadd{azmpg}}, see=[Glossary:]{azmopg}}
