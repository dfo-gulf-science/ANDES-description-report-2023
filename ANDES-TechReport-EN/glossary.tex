...
%%%
\newglossaryentry{REST-APIg}{name=REST,
...
\newglossaryentry{REST-API} {
    type=\acronymtype,
    name={REST-API},
    description={Representational state transfer (REST) is a software architectural style that was created to guide the design and development of the architecture for the World Wide Web},
    first={REST-API},
