...
\newglossaryentry{dfog}{name={DFO},
    description={Fisheries and Oceans Canada}}
...
\newglossaryentry{gseg}{name={GSE},
    description={Groundfish Survey Entry}}

%%% define the acronym and use the see= option
\newglossaryentry{gse}{type=\acronymtype, name={GSE}, description={Groundfish Survey Entry. The GSE is a data entry tool developed in the 1980s}, first={Groundfish Survey Entry (GSE)\glsadd{gseg}}, see=[Glossary:]{gseg}}


%%% The glossary entry the acronym links to
\newglossaryentry{imtsg}{name={IMTS},
    description={Information Management and Technology Services}}

%%% define the acronym and use the see= option
\newglossaryentry{imts}{type=\acronymtype, name={IMTS}, description={Information Management and Technology Services, the IT branch of DFO}, first={Information Management and Technology Services (IMTS)\glsadd{imtsg}}, see=[Glossary:]{imtsg}}


%%% The glossary entry the acronym links to
\newglossaryentry{lang}{name={LAN},
    description={A series of connected computers that share a physical location}}

%%% define the acronym and use the see= option
\newglossaryentry{lan}{type=\acronymtype, name={LAN}, description={A Local Area Netowrk is a series of computers connected to each other and capable of communicating with each other over wired or wireless connections.}, first={local area network (LAN)\glsadd{lang}}, see=[Glossary:]{lang}}
