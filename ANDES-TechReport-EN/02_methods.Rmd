...
It is important for users to be able to define their own protocols without the intervention of a developer.



### Version Control / Source Control

The utilization of a version control system (VCS) is an indispensable component of a modern day development workflow. Version management is especially important in the context of having concurrent instances of the application in production at a given time. Knowing the version of a production instance is necessary to resolve any issues that might arise. Similarly, the application databases and backup files are intimately linked to the version number. In order to successfully re-instantiate a backup file, the version under which it was produced must be known precisely.

It was decided to use Git as the VCS for this project and to host the remote repository on the [Gulf Science organizational GitHub account](https://github.com/dfo-gulf-science).  Website is also used to manage feature requests, bugs and project milestones
