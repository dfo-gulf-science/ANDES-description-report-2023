...
Additionally, within the mission configuration, users can specify which observations and action types are should be collected for different instrument types.
