...
\gls{andes} does not currently have a well-defined governing body which makes the project vulnerable. To alleviate this situation, we ask that this technical document, as well as the developer's guide, be considered when outsourcing development efforts towards \gls{andes}. This will ensure that the core vision is maintained and that software sustainability principles are upheld.
