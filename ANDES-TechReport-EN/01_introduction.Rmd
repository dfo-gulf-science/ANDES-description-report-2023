...
- While these applications were built by \gls{dfo}, multiple attempts to obtain support for these tools from \gls{imts} were unsuccessful.
...
This project began during the summer of 2018, the first field deployment of \gls{andes} took place in the fall of 2019 during the southern Gulf of St. Lawrence September survey, where it was piloted in parallel to the \gls{ese} on board the *CCGS Teleost*.
